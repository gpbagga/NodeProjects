...
expressApp.use('/app', express.static(path.resolve('app', 'react-app','build')));
expressApp.use('/', express.static(path.resolve('app', 'react-app','build')));
expressApp.use('/app', serveIndex('app'));   // serveIndex means serve index file which is our index.html file
