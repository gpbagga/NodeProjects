...
export default function Quotation() {
    const xTopRef = useRef()
    const tableHeadingRef = useRef()
    const tableRowRef = useRef()
    const totalStuffRef = useRef()
    const taxDiv = useRef()
    const lastWordsDiv = useRef()
    const n = 85

    const [pagesStartingIndex, setPagesStartingIndex] = useState([])

    const [taxPageBreak, setTaxPageBreak] = useState(false);
    const [lastWordsBreak, setLastWordsBreak] = useState(false);
